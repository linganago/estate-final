    ...
    <main className='mx-auto max-w-6xl px-4 py-8 sm:px-6'>
      <div className='mb-8 max-w-2xl'>
        ...
        <p className='mt-3 text-sm leading-7 text-slate-600 sm:text-base'>
          Keep the listing details, pricing, and photo order sharp so the page
          stays polished for new visitors.
        </p>
      </div>
        ...
        <aside className='space-y-6'>
          <section className='rounded-[32px] border border-white/70 bg-white/90 p-6 shadow-lg shadow-slate-900/5 ring-1 ring-slate-900/5'>
            ...
            <p className='mt-2 text-sm leading-6 text-slate-600'>
              Upload up to 6 images. The first image stays the main cover on
          ...
          <section className='rounded-[32px] border border-white/70 bg-white/90 p-6 shadow-lg shadow-slate-900/5 ring-1 ring-slate-900/5'>
            <SectionEyebrow>Save changes</SectionEyebrow>
            <p className='mt-2 text-sm leading-6 text-slate-600'>
              Update the listing when the price, address, or imagery changes so
              visitors always see the most accurate version.
            </p>
